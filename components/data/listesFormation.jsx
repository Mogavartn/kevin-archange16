const listesFormations = [
    ...
    },
    {
        "formation_id": "08",
        "liste": [
            { "id": "1", "intitule": "Gestion des ressources humaines : les bases" },
            { "id": "2", "intitule": "Formation sur le management du personnel" },
            { "id": "3", "intitule": "Le leadership moderne et les différents styles" },
            { "id": "4", "intitule": "Recrutement et sélection de talents" },
            { "id": "5", "intitule": "L’intégration des collaborateurs dans une équipe" },
            { "id": "6", "intitule": "Gestion des conflits en entreprise" },
            { "id": "7", "intitule": "Suivi de la performance des employés" },
            { "id": "8", "intitule": "Droit social pour les responsables RH" },
            { "id": "9", "intitule": "Mise en place de la politique de rémunération" },
            { "id": "10", "intitule": "Consolidation des compétences en management de projet" }
        ]
    },
    {
        "formation_id": "09",
...
export default listesFormations;