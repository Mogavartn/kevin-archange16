...
const Tab = () => {
    return (
        <>
            <div className="skill__two section-padding border">
                <div className="container">
                    ...
                    <div className="row nav mb-2 gy-1 justify-content-center">
                        <div className="nav-item col-xl-6 col-lg-6 col-md-6 col-sm-6">
                    ...
                    <div className="skill__two-tab-details border">
                        <div className="row align-items-center flex-wrap-reverse gy-4 tab-pane fade show active" role="tabpanel" id="topic-1" aria-labelledby="topic-1-tab">
                            <div className="col-xl-6 col-lg-6 col-md-9 p-4 formation_rigth border">
                                <TabContent 
                            ...
                            <div className="col-xl-6 col-lg-6 col-md-9 p-4 ormation_left border">
                                        <TabContent 
